...
namespace lpsolve55
{
    public static class lpsolve
    {
...
#if MAC
        const string libpath = @"lpsolve55";
#else
        //const string libpath = @"GameData\KerbComAvionics\lpsolve55";
		const string libpath = @"Assets\kerbcom\lpsolve55";
#endif
        ...
        //[DllImport(libpath, SetLastError=true)] public static extern string get_col_name(int lp, int column);
        //[DllImport(libpath, EntryPoint = "get_col_name", SetLastError = true)]
        ...
        //[DllImport(libpath, SetLastError=true)] public static extern string get_lp_name(int lp);
        //[DllImport(libpath, EntryPoint = "get_lp_name", SetLastError = true)]
        ...
        //[DllImport(libpath, SetLastError=true)] public static extern string get_origcol_name(int lp, int column);
        //[DllImport(libpath, EntryPoint = "get_origcol_name", SetLastError = true)]
        //private unsafe static extern IntPtr get_origcol_name_c(int lp, int column);
        //[DllImport(libpath, SetLastError=true)] public static extern string get_origrow_name(int lp, int row);
        //[DllImport(libpath, EntryPoint = "get_origrow_name", SetLastError = true)]
        ...
        //[DllImport(libpath, SetLastError=true)] public static extern string get_row_name(int lp, int row);
        //[DllImport(libpath, EntryPoint = "get_row_name", SetLastError = true)]
        ...
        //[DllImport(libpath, SetLastError=true)] public static extern string get_statustext(int lp, int statuscode);
        //[DllImport(libpath, EntryPoint = "get_statustext", SetLastError = true)]
